...
.input-prefix {
    ...
    font-size: 0.875rem; color: #888; pointer-events: none;
}
.input-with-prefix { padding-left: 32px !important; }

/* Unit grid */
.empty-units { color: #aaa; font-size: 0.875rem; padding: 1rem 0; }
...
.unit-kode {
    ...
    background: #EEEDFE; padding: 1px 6px; border-radius: 4px;
    display: inline-block; margin-bottom: 2px;
}
.unit-nama { font-size: 0.8125rem; color: #1a1a2e; font-weight: 500; }

.unit-status-badge {
    font-size: 0.6875rem; padding: 2px 8px; border-radius: 8px; font-weight: 500;
}
...
.selected-summary {
    ...
    background: #F0EFFE; border-radius: 8px;
    font-size: 0.8125rem; color: #534AB7; font-weight: 500;
}
...
.summary-row {
    display: flex; justify-content: space-between; align-items: flex-start;
    gap: 8px; margin-bottom: 10px; font-size: 0.8125rem;
}
