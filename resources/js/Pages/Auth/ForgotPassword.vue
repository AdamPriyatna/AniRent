...
<template>
    <Head title="Lupa Password — AniRent" />
        ...
        <div class="auth-wrap">
            ...
            <div class="auth-left">
                ...
                <div class="brand">
                    ...
                    <h1 class="tagline">
                        Lupa password? <span class="tagline-accent">Jangan khawatir</span>
                    </h1>
                    <p class="tagline-desc">
                        Masukkan email Anda dan kami akan mengirimkan tautan untuk mereset password agar Anda dapat kembali mengakses AniRent.
                    </p>
                </div>
            </div>
            ...
            <div class="auth-right">
                <div class="form-wrap">
                    ...
                    <p class="form-sub">Masukkan email yang terdaftar</p>
                    ...
                    <p class="switch-text">
                        Ingat password Anda?
                        <Link :href="route('login')" class="switch-link">Kembali ke Login</Link>
                    </p>
