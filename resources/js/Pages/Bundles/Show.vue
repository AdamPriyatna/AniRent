...
.bc-link { color: #a5b4fc; text-decoration: none; font-weight: 500; }
.bc-sep { color: #64748b; }
...
/* Layout */
.detail-layout {
    display: grid; grid-template-columns: 380px 1fr; gap: 2.5rem; align-items: start;
    background: rgba(20, 17, 45, 0.6);
...
@media (max-width: 800px) { .detail-layout { grid-template-columns: 1fr; padding: 16px; } }
...
/* Info */
.tag-label { color: #c7d2fe; font-weight: 800; font-size: 0.75rem; letter-spacing: 1px; margin-bottom: 8px; }
.unit-nama { font-size: 2rem; font-weight: 800; color: #ffffff; margin-bottom: 12px; line-height: 1.2; }

.price-section { display: flex; flex-direction: column; }
.price-val { font-size: 1.75rem; font-weight: 800; color: #a5b4fc; }
.price-unit { font-size: 0.875rem; color: #94a3b8; }

.deskripsi { font-size: 0.95rem; color: #cbd5e1; line-height: 1.7; margin-bottom: 1.5rem; }
.divider { border: none; border-top: 1px solid rgba(255, 255, 255, 0.1); margin: 1.5rem 0; }

/* Units */
.section-title { font-size: 1rem; font-weight: 700; color: #ffffff; margin-bottom: 12px; }
.unit-list { display: flex; flex-direction: column; gap: 10px; }
.unit-item { display: flex; align-items: center; padding: 12px 16px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; }
.unit-info { flex: 1; display: flex; justify-content: space-between; align-items: center; }
.unit-name { font-size: 0.9375rem; font-weight: 600; color: #f8fafc; }
...
.label { display: block; font-size: 0.9rem; font-weight: 700; color: #0f172a; margin-bottom: 6px; }
.req { color: #D85A30; }
.input {
    width: 100%; padding: 12px 14px;
    background: #f1f5f9;
    border: 2px solid #cbd5e1; border-radius: 10px;
    font-size: 0.95rem; font-weight: 600; outline: none; box-sizing: border-box;
    transition: all 0.2s ease;
    color: #0f172a;
    color-scheme: light;
}
.input:focus { border-color: #534AB7; background: #ffffff; box-shadow: 0 0 0 4px rgba(83, 74, 183, 0.15); }
